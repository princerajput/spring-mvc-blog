...
<body>
	...
	<div class="fixed-top">
		<nav
			...
			<div class="container">
				<a class="navbar-brand" href="allBlogs.html"
					style="text-transform: uppercase;"> The College Fever </a>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<ul class="navbar-nav ml-auto">
						<c:choose>
	  						...
	  						<li class="nav-item"><a class="nav-link" href="/RegistrationForm.html">Register</a></li>
	  						
							</c:when>
							<c:otherwise>
							<li class="nav-item"><a class="nav-link" href="/new-blog-entry.html">Write Blog</a></li>
